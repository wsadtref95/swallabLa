...
return [
    ...
    'required_if'          => '當 :other 是 :value 時，:attribute 字段是必須的。',
    'required_unless'      => '除非 :other 是在 :values 中，否則 :attribute 字段是必須的。',
    'required_with'        => '當 :values 存在時，:attribute 字段是必須的。',
    'required_with_all'    => '當 :values 存在時，:attribute 字段是必須的。',
    'required_without'     => '當 :values 不存在時，:attribute 字段是必須的。',
    'required_without_all' => '當沒有一個 :values 存在時，:attribute 字段是必須的。',
